...
/***/ function(module, exports, __webpack_require__) {
	...
	var _indexofPolyfill = __webpack_require__(1);

	var _indexofPolyfill2 = _interopRequireWildcard(_indexofPolyfill);
	...
	var _canUseDom = __webpack_require__(5);

	var _canUseDom2 = _interopRequireWildcard(_canUseDom);

	var noConflictShortcut, globalPause, shortcut;

	_indexofPolyfill2['default']();
	...
	noConflictShortcut = _canUseDom2['default'] ? window.shortcut : undefined.shortcut;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _domLoaded = __webpack_require__(7);

	var _domLoaded2 = _interopRequireWildcard(_domLoaded);

	var _mappings = __webpack_require__(8);

	var _mappings2 = _interopRequireWildcard(_mappings);

	var _pausedMappings = __webpack_require__(9);

	var _pausedMappings2 = _interopRequireWildcard(_pausedMappings);

	var _bindsTo = __webpack_require__(10);

	var _bindsTo2 = _interopRequireWildcard(_bindsTo);

	var _preventDefaultFn = __webpack_require__(11);

	var _preventDefaultFn2 = _interopRequireWildcard(_preventDefaultFn);

	var _pauseFn = __webpack_require__(12);

	var _pauseFn2 = _interopRequireWildcard(_pauseFn);

	var _resumeFn = __webpack_require__(13);

	var _resumeFn2 = _interopRequireWildcard(_resumeFn);

	var _unbindFn = __webpack_require__(14);

	var _unbindFn2 = _interopRequireWildcard(_unbindFn);

	var _triggerFn = __webpack_require__(15);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = function () {
	  if (!/Mobi/.test(navigator.userAgent) && _canUseDom2['default']) {
	...
	(function () {
	  ...
	  function ready() {
	    ...
	    for (key in _mappings2['default']) {
	      if (!_mappings2['default'].hasOwnProperty(key)) {
	        continue;
	      }
	      ...
	      for (selectorKey in elSelectors) {
	        if (!elSelectors.hasOwnProperty(selectorKey)) {
	          continue;
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = function (fn) {
	  ...
	  if (typeof fn !== 'function') {
	    return _error2['default']('You must pass a function to the bindsTo method, check the call for the shortcut(\'' + this.keys + '\', \'' + this.selector + '\') method');
	  }
